...
import WelcomePage from "../form/welcomepage.jsx";
const Item = ({
  title,
  to,
  icon,
  ...
  const handleClick = () => { 
    if (title === t["WelcomeScreen"]) {
      navigate(`/${v}/welcome`); // Navigate to the welcome screen
    } else if (title === t["Manage Items"]) {
...
const Sidebar = ({
  ...
  const WelcomeScreen = `Welcome, ${username}!`;
        ...
        <Menu iconShape="circle">
          ...
          <Box>
            ...
            /> */}
             {/* <MenuItem
  component={Link} 
  to={`/${v}/welcome`} // Use the correct path to the WelcomePage
  icon={<PersonIcon style={{ color: colors.grey[100] }} />}
>
